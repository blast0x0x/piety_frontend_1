export default function FoundersRoiTable4() {
  const rows = [
...
VIP Founder Investment Profile
        </h2>
        <div className="mt-4" />
      </div>

      <div className="space-y-2">
        <h3 className="text-xl md:text-2xl text-[#eab30b] font-semibold">$50,000 Investment</h3>
        <ul className="list-disc pl-6 space-y-2 text-base md:text-lg leading-relaxed">
          <li>Multiple Dedicated VB slots (5+ VBs under your umbrella)</li>
          <li>Compounding dividends + token acceleration</li>
        </ul>
      </div>
    </div>
